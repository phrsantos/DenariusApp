...
<html lang="en">
  <head>
    ...
    <title>Denarius Admin Page </title>
  ...
  <body class="login">
    <div>
      ...
      <a class="hiddenanchor" id="signin"></a>
				...
				<div class="denarius_icon">
				<h1><img src="images/denarius_logo.jpg" alt="..." class="img-circle profile_img"></h1>
				</div>
        ...
        <div class="animate form login_form">
          ...
          <section class="login_content">
			...
			<form action="login.php" method="post" >				
              ...
              <h1>Denarius Admin</h1>
              <div>
                <input name ="nome" type="text" class="form-control" placeholder="Usuário" required="Oi" />
				<span class="error"><?php echo $nomeError;?></span>
              </div>
              <div>
